...
3. Goto phpmyadmin (http://localhost/phpmyadmin/) and create a database named **370project** and
 then import the file named **370project.sql**
4. Then launch the site http://localhost/370project/index.html
